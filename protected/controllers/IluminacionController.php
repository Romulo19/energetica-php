...
class IluminacionController extends Controller
{
	 ...
	 */
	public function actionDelete($id, $idA)
	{
		$this->loadModel($id)->delete();

		// if AJAX request (triggered by deletion via admin grid view), we should not redirect the browser
		if(!isset($_GET['ajax']))
			$this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('/areas/view', 'id'=>$idA));
	}
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['Iluminacion']))
			$model->attributes=$_GET['Iluminacion'];
	 ...
	 * @return Iluminacion the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Iluminacion::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Iluminacion $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='iluminacion-form')
		{
